                ...
                <div className="grid lg:grid-cols-3 gap-8 items-start mt-10">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div data-aos="fade-right">
                            <div className={`flex items-center duration-150 gap-3 px-3 py-2 rounded-xl shadow border ${order ? "bg-gray-800 border-gray-700 text-gray-200" : "bg-gray-100 border-gray-200 text-gray-800"}`}>
                        ...
                        <div className={` p-6 rounded-xl shadow border ${order ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
                            <form ref={Data} onSubmit={Submit} className="flex flex-col gap-4">
                                ...
                                <Textarea
                                    ...
                                    style={{ transition: 'all 150ms' }}
                                    className={`w-full px-4 py-2 duration-150 rounded-lg outline-none resize-none ${order
                                        ? "bg-gray-900 border-gray-700 text-white placeholder-gray-400"
                                        : "bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-500"
                                        }`}
                                ></Textarea>
